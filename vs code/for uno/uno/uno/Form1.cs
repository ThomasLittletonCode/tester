...
namespace uno
{
    public partial class Form1 : Form
    {
        ...
        public void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            {
                PointF point = new PointF(75, 400);
            ...
            {
                PointF point = new PointF(75, 300);
            ...
            {
                PointF point = new PointF(75, 200); 
            ...
            {
                PointF point = new PointF(75, 100);
            ...
            //draw back of uno card in the middle for pick up pile
        ...
        */
        ...
        public void ShuffleunoCard()
        {
            ...
            {
                p1Hand[i] = unoCard[i];
                p2Hand[i] = unoCard[i + handSize];
                p3Hand[i] = unoCard[i + handSize];
                p4Hand[i] = unoCard[i + handSize];
